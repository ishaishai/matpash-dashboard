...
import Users from "./components/users_table";
import User_permission from "./components/user_permission";
import User_view_permission from "./components/user_view_permission";
    ...
    return (
      <div className="bg-primary col-md px-2">
        ...
        <div className="row w-100 mb-3 bgg">
            <div className="col-8">
               <Link to="/" className="btn btn-lg bg-primary text-white btn-outline-primary" >מתפ״ש- מערכת הרשאות משתמשים </Link>
            </div>
        </div>
    </div>
    )
